...
rating: "4.8",
description:
"Discover quality fashion products and accessories from a trusted local business.",
},
{
name: "ADADI Fresh Market",
category: "Food & Drinks",
location: "Nigeria",
rating: "4.9",
description:
"Fresh food, groceries and everyday essentials delivered from local sellers.",
},
{
name: "Tech Haven",
...
rating: "4.7",
description:
"Shop phones, gadgets, accessories and other electronics from local businesses.",
},
];

export default function Home() {
return ( <main className="min-h-screen bg-[#faf7f7] text-gray-900">
    ...
    <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur">
          ...
          <span>
            Discover local businesses on ADADI
          </span>
        </div>
      ...
      <div className="flex items-end justify-between gap-6">
        <div>
          ...
          <p className="mt-3 text-sm text-gray-500 sm:text-base">
            Explore businesses and discover something new.
          </p>
        </div>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {featuredBusinesses.map((business) => (
          ...
          >
            ...
            <div className="relative flex h-44 items-center justify-center bg-gradient-to-br from-[#6b1224] to-[#8f2942]">
              <Store className="h-16 w-16 text-white/20" />

              <div className="absolute left-5 top-5 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-[#6b1224]">
                {business.category}
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-1 rounded-lg bg-amber-50 px-2 py-1 text-xs font-semibold text-amber-700">
              ...
              <Link
                href="/businesses"
                className="mt-5 flex items-center justify-center gap-2 rounded-xl border border-[#6b1224]/20 px-4 py-3 text-sm font-semibold text-[#6b1224] transition hover:bg-[#6b1224] hover:text-white"
              >
                Visit business
